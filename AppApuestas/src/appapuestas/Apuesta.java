...
public class Apuesta {
	...
	static {
		...
		Apuesta.equipoLocal = "Real Madrid";
		Apuesta.equipoVisitante = "Barcelona";
	...
	public String toString() {
		return "Apuesta = Nombre:" + this.nombre + ", Goles equipo local = " + this.golesLocal + ", Goles equipo visitante = " + this.golesVisitante + ", Cantidad Apostada = " + this.valorApuesta + " €";
	}
